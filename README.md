...
<img src="src/primer1.png" alt="Cnfkj" width="590" height="400">
...
2. Первое задание: Найти в программе 2 уязвимости:  
    ...
    * Создание и демонстрация графического окна, созданного графической библиотекой ( SFML, TXLib и др. ), c информацией о том, что файл был взломан и любыми дополнительными графическими фантазиями автора 
...
4) Я написал программу, которая, по описанному выше принципу,
    ...
    Результат работы программы для моего любимого пароля:
    <img src="src/parol1.jpg" alt="Cnfkj" width="590" height="400">
    <img src="src/parol2.jpg" alt="Cnfkj" width="590" height="400">
...
6) Результат:
<img src="src/bufer.png" alt="Cnfkj" width="590" height="400">
...
<img src="src/arrow.png" alt="Cnfkj" width="590" height="400">

# Результат работы 
    Запускаем пропатченый файл и вводи любой пароль из трёх символов 
    ( чтобы не переполнить буффер ) и видим: 
<img src="src/result.png" alt="Cnfkj" width="590" height="400">